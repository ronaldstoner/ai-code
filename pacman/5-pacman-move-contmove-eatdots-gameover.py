# Prompt
# python code for a pacman clone. the player can move pacman around. holding down a movement key continues movement. pacman can eat the dots. if pacman touches a ghost the game is over.
...
while not done:
    ...
    if ghost1.colliderect(player) or ghost2.colliderect(player):
        done = True

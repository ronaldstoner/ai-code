# Prompt
# python code for console based text adventure. the player has an inventory that can be shown. inside the inventory is the book "The Necronomicon". 

# This is a simple text adventure game with an inventory system
...
actions = ["north", "south", "east", "west", "look", "inventory"]

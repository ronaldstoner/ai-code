# Prompt
# python code for a hyperspace starfield animation in pygame with randomly sized stars and a FPS counter and a spaceship sprite
...
def draw_starfield():
    ...
    text_surface = font.render(fps_text, False, (255, 255, 255))
